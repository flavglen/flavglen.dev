export const categoryPatterns = [
    ...
    { pattern: /walmart|NOFRILLS|yal|eraa|costco|loblaws|sobeys|metro|no frills|nofrills|whole foods|freshco|trader joe|aldi|food basics|wegmans|jian hing|FUSION|fusion market|batala/i, category: "Groceries" },
    { pattern: /amazon|walmart|DOLLARAMA|target|ikea|costco|home depot|lowes|sephora|macy|zara|h&m|nike|adidas/i, category: "Shopping" },
    { pattern: /netflix|Amazon.ca Prime Member|spotify|disney|apple music|hotstar|jio|aha|zee|willow|prime video|youtube premium|hulu|hbo|crave|showtime|playstation|xbox/i, category: "Entertainment" },
