export const categoryPatterns = [
    ...
    { pattern: /amazon|walmart|DOLLARAMA|target|ikea|costco|home depot|lowes|sephora|macy|zara|h&m|nike|CANADIAN TIRE|adidas|BlueNotes|SVP|tommy|Hilfiger|OUTLET|OUTFITTERS|URBAN PLANET|OLD NAVY|GAP|MACYS|PUMA/i, category: "Shopping" },
    ...
    { pattern: /udemy|coursera|edx|udacity|skillshare|college|university|online course|cursor|openai|STARKCAMP|github copilot|GREATFRONTEND|LIBRARY/i, category: "Education" },
